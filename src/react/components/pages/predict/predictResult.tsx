...
export default class PredictResult extends React.Component<IPredictResultProps, IPredictResultState> {
        ...
        if (item?.type === "array" || item?.type === "object") {
            ...
            return (
                <div key={key}
                    ...
                    <li className="predictiontag-item text-light" style={style}>
                    ...
                    <li className="predictiontag-item-label mt-0 mb-1 text-dark">
    ...
    private renderPredictionItemLabel = (item, postProcessedValue) => {
        ...
        return (displayText == null ?
            <li className={postProcessedValue ? "predictiontag-item-label text-dark mt-0 text-dark" : "predictiontag-item-label-null mt-0 mb-1"}>
                {postProcessedValue ? postProcessedValue : "NULL"}
            </li>
            :
            <>
                <li className={postProcessedValue ? "predictiontag-item-label text-dark mt-0" : "text-dark predictiontag-item-label mt-0 mb-1"}>
                    {postProcessedValue ? "text: " + displayText : displayText}
                </li>
                {postProcessedValue &&
                    <li className="predictiontag-item-label text-dark mb-1">
                        {postProcessedValue}
                    </li>
                }
            </>);
