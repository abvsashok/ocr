...
const whiteOrange = {
    ...
    "themeLighter": "#fde9d5",
    "themeLight": "#fcd5b1",
    "themeTertiary": "#f9ac65",
    "themeSecondary": "#f68720",
    "themeDarkAlt": "#dc6c02",
    "themeDark": "#ba5b02",
    "themeDarker": "#894301",
    "neutralLighterAlt": "#faf9f8",
...
const grayOrangePalette = {
    "themePrimary": "#787474",
    "themeLighterAlt": "#faf9f9",
    "themeLighter": "#e9e8e8",
    "themeLight": "#d6d5d5",
    "themeTertiary": "#aeabab",
    "themeSecondary": "#888484",
    "themeDarkAlt": "#6c6969",
    "themeDark": "#5b5858",
    "themeDarker": "#434141",
    "neutralLighterAlt": "#f1eee9",
    "neutralLighter": "#edeae6",
    "neutralLight": "#e3e1dc",
    "neutralQuaternaryAlt": "#d3d1cd",
    "neutralQuaternary": "#cac8c4",
    "neutralTertiaryAlt": "#c2c0bc",
    "neutralTertiary": "#fccbb0",
    "neutralSecondary": "#f99864",
    "neutralPrimaryAlt": "#f6691e",
    "neutralPrimary": "#f55600",
    "neutralDark": "#ba4100",
    "black": "#893000",
    "white": "#f8f5f0"
  };
...
const rightPaneDefaultButtonTheme = createTheme({palette: whiteOrange});
const defaultDarkTheme = createTheme({palette: whiteOrange});
const defaultTheme = createTheme({palette: whiteOrange});
const whiteTheme = createTheme({palette: whiteOrange});
const redTheme = createTheme({palette: whiteOrange});
const greenTheme = createTheme({palette: whiteOrange});
const greyTheme = createTheme({palette: whiteOrange});
const blueTheme = createTheme({palette: whiteOrange});
const darkTheme = createTheme({palette: whiteOrange});
const darkGreyTheme = createTheme({palette: DefaultPalette});
const greenWithWhiteBackgroundTheme = createTheme({palette: whiteOrange});
const lightGreyTheme = createTheme({palette: whiteOrange});
const whiteOrangeTheme = createTheme({palette: whiteOrange});
const subMenuTheme = createTheme({palette: whiteOrange})
const grayOrangeTheme = createTheme({palette:grayOrangePalette});
...
export function getWhiteOrangeTheme() {
    return whiteOrangeTheme;
}
export function getGrayOrangeTheme(){
    return grayOrangeTheme;
}